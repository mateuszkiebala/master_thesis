...
public class MiddleNested extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 9200781466043085111L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"MiddleNested\",\"namespace\":\"minimal_algorithms.hadoop.examples.types\",\"fields\":[{\"name\":\"middle_array\",\"type\":{\"type\":\"array\",\"items\":\"float\"}},{\"name\":\"inner\",\"type\":{\"type\":\"record\",\"name\":\"InnerNested\",\"fields\":[{\"name\":\"inner_int\",\"type\":\"int\"},{\"name\":\"inner_string\",\"type\":\"string\"}]}}]}");
  public static org.apache.avro.Schema getClassSchema() { return SCHEMA$; }
  @Deprecated public java.util.List<java.lang.Float> middle_array;
  @Deprecated public minimal_algorithms.hadoop.examples.types.InnerNested inner;
   ...
   */
  public MiddleNested(java.util.List<java.lang.Float> middle_array, minimal_algorithms.hadoop.examples.types.InnerNested inner) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: inner = (minimal_algorithms.hadoop.examples.types.InnerNested)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public minimal_algorithms.hadoop.examples.types.InnerNested getInner() {
    return inner;
  }
   ...
   * @param value the value to set.
   */
  public void setInner(minimal_algorithms.hadoop.examples.types.InnerNested value) {
    this.inner = value;
  }
   ...
   */
  public static minimal_algorithms.hadoop.examples.types.MiddleNested.Builder newBuilder() {
    return new minimal_algorithms.hadoop.examples.types.MiddleNested.Builder();
  }
   ...
   * @return A new MiddleNested RecordBuilder
   */
  public static minimal_algorithms.hadoop.examples.types.MiddleNested.Builder newBuilder(minimal_algorithms.hadoop.examples.types.MiddleNested.Builder other) {
    return new minimal_algorithms.hadoop.examples.types.MiddleNested.Builder(other);
  }
   ...
   * @return A new MiddleNested RecordBuilder
   */
  public static minimal_algorithms.hadoop.examples.types.MiddleNested.Builder newBuilder(minimal_algorithms.hadoop.examples.types.MiddleNested other) {
    return new minimal_algorithms.hadoop.examples.types.MiddleNested.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<MiddleNested>
    ...
    private minimal_algorithms.hadoop.examples.types.InnerNested inner;
    private minimal_algorithms.hadoop.examples.types.InnerNested.Builder innerBuilder;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(minimal_algorithms.hadoop.examples.types.MiddleNested.Builder other) {
      super(other);
      ...
      if (other.hasInnerBuilder()) {
        this.innerBuilder = minimal_algorithms.hadoop.examples.types.InnerNested.newBuilder(other.getInnerBuilder());
      }
    }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(minimal_algorithms.hadoop.examples.types.MiddleNested other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.middle_array)) {
        this.middle_array = data().deepCopy(fields()[0].schema(), other.middle_array);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public minimal_algorithms.hadoop.examples.types.MiddleNested.Builder setMiddleArray(java.util.List<java.lang.Float> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public minimal_algorithms.hadoop.examples.types.MiddleNested.Builder clearMiddleArray() {
      middle_array = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public minimal_algorithms.hadoop.examples.types.MiddleNested.Builder setInner(minimal_algorithms.hadoop.examples.types.InnerNested value) {
     ...
     * @return This builder.
     */
    public minimal_algorithms.hadoop.examples.types.InnerNested.Builder getInnerBuilder() {
      if (innerBuilder == null) {
        if (hasInner()) {
          setInnerBuilder(minimal_algorithms.hadoop.examples.types.InnerNested.newBuilder(inner));
        } else {
          setInnerBuilder(minimal_algorithms.hadoop.examples.types.InnerNested.newBuilder());
        }
      }
      return innerBuilder;
    }
     ...
     * @return This builder.
     */
    public minimal_algorithms.hadoop.examples.types.MiddleNested.Builder setInnerBuilder(minimal_algorithms.hadoop.examples.types.InnerNested.Builder value) {
      clearInner();
      innerBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public minimal_algorithms.hadoop.examples.types.MiddleNested.Builder clearInner() {
      inner = null;
      innerBuilder = null;
    ...
    public MiddleNested build() {
      try {
        ...
        if (innerBuilder != null) {
          ...
          record.inner = fieldSetFlags()[1] ? this.inner : (minimal_algorithms.hadoop.examples.types.InnerNested) defaultValue(fields()[1]);
        }
        return record;
      } catch (Exception e) {
