...
##yarn jar $src/dist/SortAvroRecord_przyklad_avro.jar sortavro.record.InputPreprocessing4TextToAvro -libjars $yarn_libjars hdfs://$nn:9000/user/mati/input_sample_2.txt hdfs://$nn:9000/user/mati/input.dir
...
yarn jar $src/dist/SortAvroRecord_przyklad_avro.jar sortavro.SortAvroRecord -libjars $yarn_libjars hdfs://$nn:9000/user/mati/input.dir hdfs://$nn:9000/user/mati/ 20 3 3
