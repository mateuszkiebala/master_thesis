...
yarn jar $app_jar minimal_algorithms.record.InputPreprocessing4TextToAvro -libjars $yarn_libjars hdfs://$nn:9000/user/mati/input_sample_2.txt hdfs://$nn:9000/user/mati/input.dir
...
hdfs dfs -rm -r /user/mati/sampling_output
hdfs dfs -rm -r /user/mati/sorting_output
