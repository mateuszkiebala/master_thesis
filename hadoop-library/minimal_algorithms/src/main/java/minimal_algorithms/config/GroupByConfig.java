...
public class GroupByConfig extends StatisticsConfig {
    ...
    public GroupByConfig(Configuration conf, Comparator cmp, Schema baseSchema, Schema statisticsAggregatorSchema, Schema keyRecordSchema) {
        super(conf, cmp, baseSchema, statisticsAggregatorSchema);
