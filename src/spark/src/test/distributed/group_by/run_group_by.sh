...
spark-submit --class minimal_algorithms.spark.examples.group_by.ExampleGroupBy --master yarn ../../../../target/spark-1.0.0-SNAPSHOT.jar "$NUM_OF_PARTITIONS" "$HDFS/$INPUT_HDFS" "$HDFS/$OUTPUT_HDFS"
