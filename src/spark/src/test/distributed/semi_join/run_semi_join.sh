...
spark-submit --class minimal_algorithms.spark.examples.semi_join.ExampleSemiJoin --master yarn ../../../../target/scala-2.11/library_2.11-0.1.jar 10 "$HDFS/$INPUT_R_HDFS" "$HDFS/$INPUT_T_HDFS" "$HDFS/$OUTPUT_HDFS"
