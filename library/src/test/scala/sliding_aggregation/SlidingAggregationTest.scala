...
class SlidingAggregationTest extends FunSuite with SharedSparkContext with Matchers {
  val rdd = spark.sparkContext.parallelize(Array((1, 2), (3, 5), (2, -10), (4, 1), (7, 2), (6, 1), (5, 12), (8, 10), (10, -7), (9, 2), (11, 5)).map{e => new TestSlidingObject(e._1, e._2)})
  ...
  test("SlidingAggregation sum") {
    ...
    val statsAgg = (o: TestSlidingObject) => new SumAggregator(o.getWeight)
      ...
      // when
    val result = new MinimalSlidingAggregation[TestSlidingObject](spark, 3).importObjects(rdd).aggregate(7, cmpKey, statsAgg).collect()
  ...
  test("SlidingAggregation max") {
    ...
    val statsAgg = (o: TestSlidingObject) => new MaxAggregator(o.getWeight)
      ...
      // when
    val result = new MinimalSlidingAggregation[TestSlidingObject](spark, 3).aggregated(rdd, 7, cmpKey, statsAgg).collect()
